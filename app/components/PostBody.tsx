...
import { PostBodyProps } from "@/app/types";
    ...
    <PortableText
      ...
      components={{
        ...
        block: {
          ...
          h4: ({children}) => <h4 className="text-4xl font-bold mt-5 mb-2 text-center max-w-[var(--text-max-width)] mx-auto leading-tight" style={{"--text-max-width": TEXT_MAX_WIDTH} as React.CSSProperties}>{children}</h4>,
